...
{
    public partial class DCT1 : Form
    {
     ...
     '8', '9', 'A', 'B', 'C', 'D', 'E', 'F'};
        ...
        private void DCT1_Load(object sender, EventArgs e)
        {
        ...
        {
            Quantization1 obj = new Quantization1((Bitmap)DCTMapImage.Image);
            ActiveForm.Hide();
            obj.Show();
        }
    }
