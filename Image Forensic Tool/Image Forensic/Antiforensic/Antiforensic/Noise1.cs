...
{
    public partial class Noise1 : Form
    {
        public Noise1()
        {
            InitializeComponent();
        ...
        public Noise1(Bitmap orgDCT,Bitmap NewDCT)
        {
            InitializeComponent();
            ov = orgDCT;
        ...
        public Bitmap difference(Bitmap orgDCT, Bitmap NewDCT)
        {
            ...
            for (int i = 0; i < orgDCT.Width; i++)
            {
                ...
                label4.Text = Math.Round(change, 2).ToString() + " %";
        ...
        public void addNoise(Bitmap orgDCT, Bitmap NewDCT)
        {
            ...
            for (int i = 0; i < ov.Width; i++)
            {
                ...
                else
                {
                    ...
                    label8.Text = Math.Round(change, 2).ToString() + " %";
        ...
        {
            Final1 obj = new Final1((Bitmap)NOISEDCT.Image);
            ActiveForm.Hide();
            obj.Show();
        }
